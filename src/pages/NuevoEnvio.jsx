          ...
          <div className="cot-block">
              <div className="cot-left">
                  <div className="cot-info">
                      ...
                      <div>
                          <p className="cot-label">{t("newOrder.fields.cotLabel")}</p>
                          <p className="cot-sublabel">{t("newOrder.fields.cotSublabel")}</p>
                      </div>
                  </div>

                  {cotEstado === "generado" && cotNumero && (
                      <div className="cot-numero">
                          <span className="cot-numero-label">{t("newOrder.fields.cotGenerado")}</span>
              ...
              >
                  {cotEstado === "idle" && (
                      <>
                          ...
                          {t("newOrder.fields.generarCot")}
                      </>
                  )}
                  {cotEstado === "generando" && (
                      <>
                          <span className="cot-spinner" />
                          {t("newOrder.fields.generandoCot")}
                      </>
                  )}
                  {cotEstado === "generado" && (
                      <>
