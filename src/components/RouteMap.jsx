...
const finishIcon = L.divIcon({
    html: `
    <div style="display: flex; justify-content: center; align-items: center; width: 36px; height: 36px; background: #1e293b; border: 3px solid #fff; border-radius: 50%; box-shadow: 0 4px 10px rgba(0,0,0,0.4); overflow: hidden;">
